...
// Observe service cards, project cards, and other elements
...
This inquiry was sent from Ambay Construction website.
        `.trim();
...
window.addEventListener('load', () => {
    ...
    loader.innerHTML = `
        <div style="text-align: center;">
            <div style="width: 50px; height: 50px; border: 3px solid #f3f3f3; border-top: 3px solid #e67e22; border-radius: 50%; animation: spin 1s linear infinite; margin: 0 auto 20px;"></div>
            <p style="color: #e67e22; font-weight: bold;">Loading Ambay Construction...</p>
        </div>
    `;
